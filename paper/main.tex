...
\author{Aadrika Deokathe\inst{1,\dagger} \and 
Khushi Chadda\inst{1,\dagger} \and 
Harsh Chhatri\inst{1} \and 
Dr.~Shweta Gangrade\inst{1}\textsuperscript{(\Envelope)}}
...
\email{\{aadrikadeokathe28, khushichadda2004\}@gmail.com}, \email{shweta.gangrade@nmims.edu}\\[0.4ex]
\textsuperscript{$\dagger$}These authors contributed equally to this work. \quad \textsuperscript{(\Envelope)}Corresponding author.}
...
\hline
\textbf{Target Dataset (Modality)} & \textbf{Dice Score (Mean $\pm$ Std)} & \textbf{HD95 Distance (mm)} & \textbf{Inference Speed} \\
\hline
Spleen (CT)           & $0.178 \pm 0.148$ & $77.81 \pm 32.96$ & $128.8\text{ ms/slice}$ \\
Liver (CT)            & $0.683 \pm 0.313$ & $32.15 \pm 12.39$ & $128.8\text{ ms/slice}$ \\
Heart (Cine MRI)      & $0.409 \pm 0.267$ & $40.46 \pm 61.69$ & $128.8\text{ ms/slice}$ \\
Brain Tumour (MRI)    & $0.403 \pm 0.306$ & $32.71 \pm 45.28$ & $128.8\text{ ms/slice}$ \\
\hline
\textbf{Parameter Footprint} & \multicolumn{3}{c}{$355\text{K}$ Trainable ($23.1\%$) / $1.18\text{M}$ Frozen Backbone ($76.9\%$)} \\
\hline
\end{tabular}
\end{table}
